...
Where `service` is the name of the service package generated by Goa.

- in the service method implementation:

```go
func (s *Service) Get(ctx context.Context, p *GetPayload) (res *GetResult, err error) {
        log.Info(ctx, "calling Get") // ctx is ready-to-use
        // ...
}
```
