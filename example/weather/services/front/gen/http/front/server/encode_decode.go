...
// forecast endpoint.
func DecodeForecastRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (string, error) {
...
// test_all endpoint.
func DecodeTestAllRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*front.TestAllPayload, error) {
	return func(r *http.Request) (*front.TestAllPayload, error) {
		var payload *front.TestAllPayload
		var (
