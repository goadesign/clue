...
func TestForecast(t *testing.T) {
	...
	f, err := s.Forecast(context.Background(), &genforecast.ForecastPayload{Lat: latitude, Long: longitude})
	if err != nil {
	...
	_, err = s.Forecast(context.Background(), &genforecast.ForecastPayload{Lat: latitude, Long: longitude})
	if err == nil {
