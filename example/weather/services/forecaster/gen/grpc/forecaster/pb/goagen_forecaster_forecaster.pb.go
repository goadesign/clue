...
var file_goagen_forecaster_forecaster_proto_rawDesc = []byte{
...
var (
	...
	file_goagen_forecaster_forecaster_proto_rawDescData = file_goagen_forecaster_forecaster_proto_rawDesc
)

func file_goagen_forecaster_forecaster_proto_rawDescGZIP() []byte {
	file_goagen_forecaster_forecaster_proto_rawDescOnce.Do(func() {
		file_goagen_forecaster_forecaster_proto_rawDescData = protoimpl.X.CompressGZIP(file_goagen_forecaster_forecaster_proto_rawDescData)
	})
...
var file_goagen_forecaster_forecaster_proto_goTypes = []interface{}{
...
func file_goagen_forecaster_forecaster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_goagen_forecaster_forecaster_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_goagen_forecaster_forecaster_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_goagen_forecaster_forecaster_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_goagen_forecaster_forecaster_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Period); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_goagen_forecaster_forecaster_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_goagen_forecaster_forecaster_proto_rawDesc = nil
