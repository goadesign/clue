...
func NewForecastRequest(payload *forecaster.ForecastPayload) *forecasterpb.ForecastRequest {
...
func ValidateLocation(message *forecasterpb.Location) (err error) {

	return
}

// ValidatePeriod runs the validations defined on Period.
func ValidatePeriod(message *forecasterpb.Period) (err error) {
