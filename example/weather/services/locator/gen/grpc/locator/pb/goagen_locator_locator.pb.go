...
var file_goagen_locator_locator_proto_rawDesc = string([]byte{
...
var (
	...
	file_goagen_locator_locator_proto_rawDescData []byte
)

func file_goagen_locator_locator_proto_rawDescGZIP() []byte {
	file_goagen_locator_locator_proto_rawDescOnce.Do(func() {
		file_goagen_locator_locator_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_goagen_locator_locator_proto_rawDesc), len(file_goagen_locator_locator_proto_rawDesc)))
	})
...
var file_goagen_locator_locator_proto_goTypes = []any{
...
func file_goagen_locator_locator_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_goagen_locator_locator_proto_rawDesc), len(file_goagen_locator_locator_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
