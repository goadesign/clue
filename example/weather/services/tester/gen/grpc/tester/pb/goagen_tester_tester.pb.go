...
var file_goagen_tester_tester_proto_rawDesc = string([]byte{
...
var (
	...
	file_goagen_tester_tester_proto_rawDescData []byte
)

func file_goagen_tester_tester_proto_rawDescGZIP() []byte {
	file_goagen_tester_tester_proto_rawDescOnce.Do(func() {
		file_goagen_tester_tester_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_goagen_tester_tester_proto_rawDesc), len(file_goagen_tester_tester_proto_rawDesc)))
	})
...
var file_goagen_tester_tester_proto_goTypes = []any{
...
func file_goagen_tester_tester_proto_init() {
	...
	file_goagen_tester_tester_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_goagen_tester_tester_proto_rawDesc), len(file_goagen_tester_tester_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
